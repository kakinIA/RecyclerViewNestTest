...
public class MyGankFuliFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private MyGankFuliAdapter mAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new MyGankFuliAdapter(getContext(), fuliList);
        gridRv.setLayoutManager(gridLayoutManager = new GridLayoutManager(getActivity(), 2));
    ...
    private RecyclerView.OnScrollListener scrollListener = new RecyclerView.OnScrollListener() {
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            if (loadMoreFlag && gridLayoutManager.findLastVisibleItemPosition() >= fuliList.size() - 3) {
                loadMoreFlag = false;
